...
export const InputSignal: React.FC<InputSignalProps> = (
    ...
    return (
        <>
            <div className=" p-[10px] border border-secondaryColor rounded bg-[#f6f6f6] text-left">
                <div className="flex flex-wrap">
                    <h6 className="w-[100%]">Input Signal</h6>
                    <div className="w-[28%]">
                        <select className=" bg-transparent pt-[3px] pb-[3px] border border-[#a3a3a3] rounded-xl text-[12px] font-[500]"
